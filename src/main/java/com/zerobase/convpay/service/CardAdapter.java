...
public class CardAdapter implements PaymentInterface {
    ...
    public CardUseCancelResult cancelCapture(Integer payCancelAmount) {
        if (payCancelAmount < 1000) {
            return CardUseCancelResult.CARD_USE_CANCEL_FAIL;
        }

        return CardUseCancelResult.CARD_USE_CANCEL_SUCCESS;
    }
    ...
    public CancelPaymentResult cancelPayment(Integer cancelAmount) {
        ...
        if (cardUseCancelResult == CardUseCancelResult.CARD_USE_CANCEL_FAIL) {
